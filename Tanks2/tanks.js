...
function updateStoreCounts(){log('update store counts');var tank=tanks[tankNo];var valMap={'health-item':tank.health,'targeting-item':tank.targeting, 'fuel-item':tank.fuel,'shield-item':tank.shields,'medium-shell-item':tank.weapons[1].ammo,'large-shell-item':tank.weapons[2].ammo,'atomic-shell-item':tank.weapons[3].ammo,'cannon-ball-item':tank.weapons[4].ammo,'air-strike-item':tank.weapons[5].ammo,'emp-item':tank.weapons[6].ammo, 'sniper-shell-item': tank.weapons[8].ammo, 'napalm-item':tank.weapons[7].ammo, 'machine-gun-item': tank.weapons[9].ammo}
