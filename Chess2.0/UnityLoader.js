...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'ChessGameWebGL-fast.data';
    var REMOTE_PACKAGE_BASE = 'ChessGameWebGL-fast.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6016189;
      var PACKAGE_UUID = '4467c31f-b408-458a-8d8b-21a6c580eb2f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21068, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(21068, 33268, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(33268, 104180, 0, 0).open('GET', '/level0');
    new DataRequest(104180, 104941, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(104941, 108071, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(108071, 2541111, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(2541111, 2592016, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(2592016, 4430464, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4430464, 5927836, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5927836, 5988564, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(5988564, 6016189, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_ChessGameWebGL-fast.data');

    };
    Module['addRunDependency']('datafile_ChessGameWebGL-fast.data');
