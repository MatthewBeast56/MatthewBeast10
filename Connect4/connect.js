...
s+='</div>';}
s+='<div id="hist" style="font: 14px arial; color: green; position:absolute; left:5px; bottom:-40px; text-align:left;">History</div>';s+='<div style="font: 9px arial; color: gold; position:absolute; right:10px; bottom:-50px;">&copy; 2018 MathsIsFun.com  v'+this.version+'</div>';s+='</div>';document.write(s);for(var row=0;row<ROWS;row++){board[row]=[];for(var col=0;col<COLS;col++){board[row][col]=0;}}
fill_lines()
